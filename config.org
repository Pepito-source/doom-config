...
I can't find a way to make org-roam-bibtex work as I want with the following code:
#+begin_src emacs-lisp :tangle no
...
"
         ...
         :unnarrowed t)))
#+end_src
Thus, I'll try to bind the bibtex-completion-edit-notes to citar-org-roam--create-capture-note
#+begin_src emacs-lisp :tangle no
(defun my-org-ref-open-bibtex-notes-advice (orig-fun &rest args)
  "Advice function to execute citar-org-roam--create-capture-note after org-ref-open-bibtex-notes."
  (apply orig-fun args)
  (citar-org-roam--create-capture-note))

(advice-add 'org-ref-open-bibtex-notes :after #'my-org-ref-open-bibtex-notes-advice)

#+end_src
Still doesnt work.

* Bibliography: citar and org-ref
